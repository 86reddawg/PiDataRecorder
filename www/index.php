...
//    echo $device.", ".$channel.", Units: ".$units.", UTC-4hrs";
    ...
    echo "<div style=\"float:left\"><div id=\"placeholder\" style=\"width:700px;height:450px\"></div></div> ";
    ...
    $query="SELECT DISTINCT DATE(stamp) as mydate FROM data ORDER BY mydate DESC";
...
$(function () {
	...
	yaxis: {tickDecimals:2, min: 40, max: 80  },
	y2axis: {tickDecimals:2, min: 5, max: 15  },
	crosshair: {mode: "x" },
    ...
    var overview = $.plot(overviewholder, data, {
        ...
        xaxis: { ticks: 0 },
        yaxis: { ticks: 0, min: 40, max: 80 },
        y2axis: { ticks: 0, min: 8, max: 15 },
        grid: { color: "#999" },
        selection: { mode: "xy" }
    });
